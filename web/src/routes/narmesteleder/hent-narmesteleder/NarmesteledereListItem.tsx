...
const NarmesteledereListItem = ({ narmesteLedereKey, value }: NarmesteldereListProps): ReactElement => {
    ...
    return (
        <li className="flex border-b border-gray-600 py-1 max-[1130px]:flex-col">
            <BodyShort className="min-w-[18rem] font-bold">{narmesteLedereKey}: </BodyShort>
